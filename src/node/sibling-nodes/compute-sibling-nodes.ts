 ...
 * @category Node
 */
export function computeSiblingNodes<Node extends SceneNode>(nodes: Array<Node>): Array<Array<Node>> {
...
function resolveGroups<Node extends SceneNode>(nodes: Array<Node>): Array<Array<Node>> {
